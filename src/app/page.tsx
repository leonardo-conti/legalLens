        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">LegalLens</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Smart Document Analysis</h3>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Ask specific questions about your document and get instant, contextual answers from our AI assistant
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Upload Your Document</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Chat with our AI assistant to ask specific questions about your document and get instant, helpful answers.
              </p>
            </div>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8 mb-12">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Get started by uploading a PDF or pasting your legal text</p>
          </div>
          <FileUpload />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="flex items-center justify-center space-x-3 mb-4">
              ...
              <span className="text-xl font-bold">LegalLens</span>
            </div>
            <p className="text-gray-400 mb-6 max-w-2xl mx-auto">
              Making legal documents accessible to everyone through AI-powered analysis and plain English explanations.
            </p>
            <div className="border-t border-gray-800 pt-8 text-gray-400">
              <p>LegalLens - Making legal documents accessible to everyone</p>
            </div>
          </div>
        </div>
      </footer>
